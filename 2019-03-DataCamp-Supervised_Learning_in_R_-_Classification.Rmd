...
Quando vários vizinhos mais próximos realizam um voto, às vezes pode ser útil examinar se os votantes foram unânimes ou amplamente separados.

Por exemplo, saber mais sobre os votantes na classificação pode permitir que um veículo autônomo use cautela quando haver alguma chance de um sinal de parada estar próximo.
